(function () {
  ...
  function fillSettings() {
    ...
    setShortcutField("shortcut-selection-lookup", settings.shortcuts?.selectionLookup ?? "Alt+D");
    setChecked("start-on-boot", settings.behavior?.startOnBoot);
  ...
  function readSettings() {
    ...
    settings.behavior.startOnBoot = $("#start-on-boot").checked;
